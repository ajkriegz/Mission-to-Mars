...
# assigned parent element, slide_elem, as the variable to look for the <div /> tag
# and its descendant (the other tags within the <div /> element)
html = browser.html
...
df = pd.read_html('https://galaxyfacts-mars.com')[0] # .read_html() searches specifically for a table
...
# Stop draining computer resources
# 5. Quit the browser
browser.quit()